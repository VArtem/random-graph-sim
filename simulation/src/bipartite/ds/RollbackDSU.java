package bipartite.ds;

import java.util.Arrays;

public class RollbackDSU {
    /**
     * parent[i] = -size of set containing i, if i is the representative
     * parent[i] = j, if i is not a representative and j is the parent in DSU tree
     */
    public int[] parent;
    public int[] stack;
